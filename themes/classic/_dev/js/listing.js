...
$(document).ready(() => {
  ...
  $('body').on('click', '#search_filter_toggler', function () {
    ...
    $('#search_filters_brands').addClass('hidden-sm-down');
    $('#footer').addClass('hidden-sm-down');

    $('#af_form').css('display', 'block');
    $('.af_filter').addClass('closed');
  });
  $('#search_filter_controls .clear').on('click', function () {
    $('#search_filters_wrapper').addClass('hidden-sm-down');
    $('#content-wrapper').removeClass('hidden-sm-down');
    $('#search_filters_brands').removeClass('hidden-sm-down');
...
function updateProductListDOM (data) {
  ...
  ajaxFavorites();
  $('.total_items').replaceWith('<span class="total_items">(' + parseInt(products_num) + ')</span>');
