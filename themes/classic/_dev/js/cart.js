  ...
  $.each($(spinnerSelector), function (index, spinner) {
     $(spinner).TouchSpin({
      ...
      // verticaldownclass: 'material-icons touchspin-down',
       buttondown_class: 'btn btn-down btn-touchspin js-touchspin js-increase-product-quantity',
       buttonup_class: 'btn btn-up btn-touchspin js-touchspin js-decrease-product-quantity',
